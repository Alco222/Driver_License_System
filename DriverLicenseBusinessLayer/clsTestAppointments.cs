...
namespace DriverLicenseBusinessLayer
{
    public class clsTestAppointments
    {
        ...
        private bool _AddNewTestAppointment()
        {
            ...
            this.TestAppointmentID = clsTestAppointementsData.AddNewAppointment((int)this.TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        private bool _UpdateTestAppointment()
        {
            ...
            return clsTestAppointementsData.UpdateTestAppointment(this.TestAppointmentID, (int)this.TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        public static clsTestAppointments Find(int TestAppointmentID)
        {
            ...
            if (clsTestAppointementsData.GetTestAppointmentInfoByID(TestAppointmentID, ref TestTypeID, ref LocalDrivingLicenseApplicationID,
        ...
        public static clsTestAppointments Find(int LocalDrivingLicenseApplicationID,clsTestTypes.enTestType TestTypeID)
        {
            int TestAppointmentID = -1;
            DateTime AppointmentDate = DateTime.Now; float PaidFees = 0;
            int CreatedByUserID = -1; bool IsLocked = false; int RetakeTestApplicationID = -1;

            if (clsTestAppointementsData.GetTestAppointmentInfoByTestTypeIDAndLocalLicenssID(ref TestAppointmentID,(int)TestTypeID,LocalDrivingLicenseApplicationID,
            ref AppointmentDate, ref PaidFees, ref CreatedByUserID, ref IsLocked, ref RetakeTestApplicationID))
        ...
        public static clsTestAppointments GetLastTestAppointment(int LocalDrivingLicenseApplicationID, clsTestTypes.enTestType TestTypeID)
        {
            ...
            if (clsTestAppointementsData.GetLastTestAppointment(LocalDrivingLicenseApplicationID, (int)TestTypeID,
        ...
        {
            return clsTestAppointementsData.GetAllTestAppointments();

        }

        public DataTable GetApplicationTestAppointmentsPerTestType(clsTestTypes.enTestType TestTypeID)
        {
            return clsTestAppointementsData.GetApplicationTestAppointmentsPerTestType(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);
        ...
        {
            return clsTestAppointementsData.GetApplicationTestAppointmentsPerTestType(LocalDrivingLicenseApplicationID, (int)TestTypeID);
        ...
        {
            return clsTestAppointementsData.GetTestID(TestAppointmentID);
        }
