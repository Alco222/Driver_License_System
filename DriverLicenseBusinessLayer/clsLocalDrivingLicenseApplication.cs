...
namespace DriverLicenseBusinessLayer
{
    public class clsLocalDrivingLicenseApplication : clsApplication
    {
...

        {
            ...
            this.LicenseClassInfo = clsClassLicense.Find(LicenseClassID);
            Mode = enMode.Update;
        }
        ...
        public int IssueLicenseForTheFirtTime(string Notes, int CreatedByUserID)
        {
            ...
            License.ExpirationDate = DateTime.Now.AddYears(this.LicenseClassInfo.ValidityLenghtYear);
            License.Notes = Notes;
            License.PaidFees = this.LicenseClassInfo.FessClass;
